...
- **さがす**では、時間帯ごとに詳しい申込みカードを表示します。活動、ボランティアの役割、1つ以上の空き時間帯、または募集内容・登録者名に一致するキーワードで絞り込めます。
...
- スクロール中もスケジュール操作欄は表示されます。「さがす」または「まとめ」の選択はブラウザに保存され、次回も引き継がれます。
